    ...
    <div className="grid  grid-rows-[auto_auto_auto] gap-3 mx-10 mt-6 ">
        ...
        <div className="col-span-2 flex flex-col">
          ...
          <div className="flex justify-between items-center">
            <div className='w-full  mr-3'>
              <Card
                cName="w-full h-auto text-white bg-gradient-to-r from-[#5B5A6F]  to-black rounded-3xl"
            ...
            <div className='w-full  ml-3'>
              <Card
                cName="w-full h-auto  text-[#343C6A] bg-white border border-[#DFEAF2] rounded-3xl"
                cardHolder="text-xs text-[#718EBF]"
                bottom=" w-full h-24 flex justify-around items-center  bg-gradient-to-br from-[rgba(255,255,255,.15)] to-[rgba(255,255,255,0)] rounded-b-3xl border-t border-[#DFEAF2]"
      ...
      <div className="grid grid-cols-3 gap-3 ">
        <div className="col-span-2 ">
          ...
          <div className="relative right-3">
            <BarChart className="bg-white w-full h-80 flex items-center justify-center rounded-3xl m-3" />
          </div>
        </div>
        <div className="flex  flex-col items-center ">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="">
          ...
          <QuickTransfer className="bg-white w-full h-64 rounded-3xl flex flex-col items-center justify-around" />
        </div>
        <div className="col-span-2  flex flex-col items-center">
          ...
          <BalanceChart className=" h-64 w-full bg-white flex items-center justify-center  rounded-3xl pt-3 pb-3" />
        </div>
      </div>
    </div>
  );
