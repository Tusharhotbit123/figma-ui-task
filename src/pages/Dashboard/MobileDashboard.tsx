    ...
    <div className="main-div bg-white overflow-x-auto">
      <div className="creadits-cards flex flex-col space-x-4">
        <div className='flex justify-around items-center mt-6 mb-6'>
          <h1 className='relative right-20 font-semibold text-base text-[#343C6A]'>My Cards</h1>
          <h1 className='relative left-14 font-semibold text-base text-[#343C6A]'>See All</h1>
        </div>
      ...
      <div className="recent flex flex-col justify-center ">
        <h1 className='text-[#343C6A] font-semibold text-base mt-6 mb-6 ml-[18px]'>Recent Transaction</h1>
       <div className='w-[325px] h-[214px] flex items-center justify-center relative left-12'>
        <Transaction/>
       </div>
      </div>
      <div className="barchart  flex flex-col mt-6">
        <h1 className=' text-[#343C6A] text-base font-semibold ml-[18px]'>Weekly Activity</h1>
      ...
      <div className="pie flex flex-col justify-center mb-36">
        <h1 className=' text-[#343C6A] text-base font-semibold ml-[18px]'>Expense Statistics</h1>
        <div className='w-full h-full  flex items-center justify-center '>
        <PieChart/>
        </div>
      </div>
      <div className="quicktransfer mb-6 flex flex-col  justify-center">
        <h1 className='font-semibold text-[18px] text-[#343C6A] ml-[18px]'>Quick Transfer</h1>
      ...
      <div className="linechart flex flex-col justify-center">
        <h1 className='text-[#343C6A] text-base font-semibold ml-[18px]'>Balance History</h1>
        <div className='flex items-center justify-center'>
