...
const MobileSetting = () => {
  ...
  if (tab === 'Preferences') {
    return (
      <div className="flex flex-col justify-center ">
        <div className="flex justify-around font-medium text-sm mt-6 mb-2 border-4">
          <button
          ...
          <button
            ...
            className="text-[#232323] underline decoration-[2px] underline-offset-[10px]"
          >
            Preferences
          </button>
          <button onClick={() => setTab('Security')} className="text-[#718EBF]">
            Security
          </button>
        </div>
        <div className="flex items-center justify-center mt-12">
