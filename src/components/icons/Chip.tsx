...
const Chip = ({ width = '35', height = '35', color = 'black' }: IIconProps) => {
  if (color === 'white') {
    return (
      //white
      <svg
      ...
      >
        <rect width="34.7713" height="34.7713" fill="url(#pattern0_1_332)" />
        <defs>
          <pattern
            id="pattern0_1_332"
            ...
            height="1"
          >
            <use xlinkHref="#image0_1_332" transform="scale(0.01)" />
          </pattern>
          <image
            id="image0_1_332"
            width="100"
  ...
  return (
    <svg
      ...
      xmlnsXlink="http://www.w3.org/1999/xlink"
    >
      <rect width="34.7713" height="34.7713" fill="url(#pattern0_1_352)" />
      <defs>
        <pattern
          id="pattern0_1_352"
          patternContentUnits="objectBoundingBox"
          ...
          height="1"
        >
          <use xlinkHref="#image0_1_352" transform="scale(0.01)" />
        </pattern>
        <image
          id="image0_1_352"
          width="100"
