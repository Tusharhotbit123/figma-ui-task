...
const DashboardMd = () => {
  return (
    <>
      <div className="hidden lg:hidden md:grid  w-full min-h-max  grid-cols-4 grid-rows-3 gap-4 p-2 ">
        <div className="col-span-2  ">
          <h1 className="font-semibold text-base text-indigo-900  w-full pl-8 pb-4 m-0 p-0">
            My Cards
          </h1>
          <Card
        ...
        <div className="col-span-2  row-span-1">
          <h1 className="font-semibold text-base text-indigo-900 w-full pb-4 pl-60">
            See All
          </h1>
          <NewCard
        ...
        <div className="col-span-2  row-span-1">
          <h1 className="font-semibold text-base text-indigo-900 w-full pl-8 pb-4">
            Recent Transaction
          </h1>
          <Transaction />
        </div>
