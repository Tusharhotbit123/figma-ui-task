...
const QuickTransfer = ({ className }: props) => {
  return (
    <div className={className}>
      <div className="flex justify-around items-center w-full h-32">
      ...
      <div className="h-12 w-full flex items-center justify-around">
        <h1 className="text-slate-400 font-normal text-base ">Write Amount</h1>
        <div className="bg-gray-100 rounded-3xl w-64 h-12 flex justify-between pl-4 items-center">
          <span className="text-slate-400 text-base ">525.50</span>
